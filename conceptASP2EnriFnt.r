...
### Usage : conceptASP2EnriFnt.r liste_concepts fichier_fnt sortie
...
if(length(arg)!=3)
  {
    cat("Usage : conceptASP2EnriFnt.r liste_concepts fichier_fnt sortie\n")
    quit()
  }
...
### Prend tout les enrichissements significatifs
