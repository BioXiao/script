...
if(flag==0)
  {
    heatmap.2(mat, Rowv=FALSE, Colv=FALSE, col=c("blue","white","red"), scale="none", dendrogram="none", trace="none", key=FALSE, keysize=0.3)
  }
if(flag==1)
  {
    heatmap.2(mat, Rowv=FALSE, Colv=FALSE, col=c("green","blue","white","red"), scale="none", dendrogram="none", trace="none", key=FALSE, keysize=0.3)
  }
dev.off()
